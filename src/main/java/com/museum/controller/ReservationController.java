...
public class ReservationController {
	...
	public String reservedDtl(ReservedHistDto reservedHistDto, @PathVariable("reservedId") Long reservedId,
			Model model) {
	...
	public String reservedUpdate(@Valid ReservedDto reservedDto, BindingResult bindingResult, Model model, 
			ReservedHistDto reservedHistDto) {
